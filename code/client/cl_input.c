...
// Ouya Linux Axis to key remap (based on SDL_gamecontrollerdb.h)
//"050000003620000100000002010000,OUYA Game Controller,a:b0,b:b3,dpdown:b9,dpleft:b10,dpright:b11,dpup:b8,guide:b14,leftshoulder:b4,leftstick:b6,
//lefttrigger:a2,leftx:a0,lefty:a1,platform:Linux,rightshoulder:b5,rightstick:b7,righttrigger:a5,rightx:a3,righty:a4,x:b1,y:b2,",

int joyAxisRemap[MAX_JOYSTICK_AXIS*2] = {
	K_JOY_LEFTSTICK_LEFT, K_JOY_LEFTSTICK_RIGHT,
	K_JOY_LEFTSTICK_UP, K_JOY_LEFTSTICK_DOWN,
	0, K_JOY_LEFTTRIGGER,
	K_JOY_RIGHTSTICK_LEFT, K_JOY_RIGHTSTICK_RIGHT,
	K_JOY_RIGHTSTICK_UP, K_JOY_RIGHTSTICK_DOWN,
	0, K_JOY_RIGHTTRIGGER,
...
// Ouya Linux Button Remap...
int joyButtonRemap[MAX_JOYSTICK_BUTTONS] = {
	K_JOY_A,
	K_JOY_X,
	K_JOY_Y,
	K_JOY_B,
	...
	0, //K_JOY_LEFTTRIGGER,
	0, //K_JOY_RIGHTTRIGGER,
	K_JOY_GUIDE, // fast double tap
	K_JOY_GUIDE // long press
};
...
void CL_JoystickAxisEvent( int localPlayerNum, int axis, int value, unsigned time ) {
	...
	negKey = joyAxisRemap[axis*2];
	posKey = joyAxisRemap[(axis*2)+1];
...
void CL_JoystickHatEvent( int localPlayerNum, int hat, int state, unsigned time ) {
	...
	upKey = K_JOY_DPAD_UP;
	rightKey = K_JOY_DPAD_RIGHT;
	downKey = K_JOY_DPAD_DOWN;
	leftKey = K_JOY_DPAD_LEFT;
