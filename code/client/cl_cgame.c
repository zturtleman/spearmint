...
// ZOID
	...
	case CG_R_ADDPOLYTOSCENE:
		re.AddPolyToScene( args[1], args[2], VMA(3), 1, args[4], 0 /* TODO sortLevel */ );
		return 0;
	case CG_R_ADDPOLYSTOSCENE:
		re.AddPolyToScene( args[1], args[2], VMA(3), args[4], args[5], 0 /* TODO sortLevel */  );
		return 0;
	...
	case CG_R_LERPTAG:
		return re.LerpTag( VMA(1), args[2], 0, args[3], 0, args[4], VMF(5), VMA(6) );
	case CG_R_LERPTAG_FRAMEMODEL:
		return re.LerpTag( VMA(1), args[2], args[3], args[4], args[5], args[6], VMF(7), VMA(8) );
